...
insert into drivers (licenceNumber, stateOfIssue, expiryDate,yearsDriving,workingWithChildren,MembermemId) values (3713856,1,'2025-06-24',15,1,1);
insert into drivers (licenceNumber, stateOfIssue, expiryDate,yearsDriving,workingWithChildren,MembermemId) values (3568718,2,'2024-09-01',18,1,2);
insert into drivers (licenceNumber, stateOfIssue, expiryDate,yearsDriving,workingWithChildren,MembermemId) values (4628912,1,'2021-12-01',24,1,4);

insert into vehicles (registration,make,model,color,spareSpots,spareChildSeats,spareBoosters,petsEverTravel,DriverDriverID) values ('1DVL938','Hyundai','ix35','grey',3,1,1,0,1);
...
insert into parents (MemberMemId,relationship) values (3,"Grandmother - paternal");
insert into parents (MemberMemId,relationship) values (4,"Mother");

insert into passengers (passFirstname,passLastname,isChild,passGender,havePetAllergies,whatAllergy,haveFoodAllergies,bigEquipmentCarried,meetingPointConsidered,passMobile,passDob,passRequiredChildSeatType,requiresEscortToClass,ParentParentID) 
...
insert into routes (routeName,startLocnId,endLocnId,routeDistance,routeTotalTime,routeStartTime,DriverDriverID) values ("Girls morning school run",1,2,13.8,17,null,1);
insert into routes (routeName,startLocnId,endLocnId,routeDistance,routeTotalTime,routeStartTime,DriverDriverID) values ("Tim's morning school run", 1,3,16.1,19,null,1);
insert into routes (routeName,startLocnId,endLocnId,routeDistance,routeTotalTime,routeStartTime,DriverDriverID) values ("Jessicas morning school run",1,2,13.8,17,null,2);
insert into routes (routeName,startLocnId,endLocnId,routeDistance,routeTotalTime,routeStartTime,DriverDriverID) values ("Tim's morning school run", 1,3,16.1,19,null,2);